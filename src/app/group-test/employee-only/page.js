                    ...
                    <div className="overflow-auto">
                        {Object.entries(
                            payrollData.reduce((acc, record) => {
                                ...
                                if (!acc[empNo]) acc[empNo] = [];
                                acc[empNo].push(record);
                                return acc;
                            }, {})
                        ).map(([empNo, records]) => (
                            <div key={empNo} className="mb-6">
                                ...
                                <h1 className="text-lg font-bold text-center mb-4">
                                    {records[0]?.employee?.Firstname} {records[0]?.employee?.Surname} - Employee No: {empNo}
                                </h1>
                                {/* Employee Table */}
                                <table className="w-full table-auto bg-white text-xs border border-gray-300">
                                    <thead className="bg-gray-100 text-gray-600">
                                        <tr>
                                            ...
                                            <th className="px-2 py-2 border border-gray-300">Payroll Date</th>
